...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ...
        ImportType = 193,
        ObjectBindingPattern = 194,
        ArrayBindingPattern = 195,
        BindingElement = 196,
        ArrayLiteralExpression = 197,
        ObjectLiteralExpression = 198,
        PropertyAccessExpression = 199,
        ElementAccessExpression = 200,
        CallExpression = 201,
        NewExpression = 202,
        TaggedTemplateExpression = 203,
        TypeAssertionExpression = 204,
        ParenthesizedExpression = 205,
        FunctionExpression = 206,
        ArrowFunction = 207,
        DeleteExpression = 208,
        TypeOfExpression = 209,
        VoidExpression = 210,
        AwaitExpression = 211,
        PrefixUnaryExpression = 212,
        PostfixUnaryExpression = 213,
        BinaryExpression = 214,
        ConditionalExpression = 215,
        TemplateExpression = 216,
        YieldExpression = 217,
        SpreadElement = 218,
        ClassExpression = 219,
        OmittedExpression = 220,
        ExpressionWithTypeArguments = 221,
        AsExpression = 222,
        NonNullExpression = 223,
        MetaProperty = 224,
        SyntheticExpression = 225,
        TemplateSpan = 226,
        SemicolonClassElement = 227,
        Block = 228,
        EmptyStatement = 229,
        VariableStatement = 230,
        ExpressionStatement = 231,
        IfStatement = 232,
        UnlessStatement = 233,
        DoStatement = 234,
        WhileStatement = 235,
        ...
        ForInStatement = 237,
        ForOfStatement = 238,
        ContinueStatement = 239,
        BreakStatement = 240,
        ReturnStatement = 241,
        WithStatement = 242,
        SwitchStatement = 243,
        LabeledStatement = 244,
        ThrowStatement = 245,
        TryStatement = 246,
        DebuggerStatement = 247,
        VariableDeclaration = 248,
        VariableDeclarationList = 249,
        FunctionDeclaration = 250,
        ClassDeclaration = 251,
        InterfaceDeclaration = 252,
        TypeAliasDeclaration = 253,
        EnumDeclaration = 254,
        ModuleDeclaration = 255,
        ModuleBlock = 256,
        CaseBlock = 257,
        NamespaceExportDeclaration = 258,
        ImportEqualsDeclaration = 259,
        ImportDeclaration = 260,
        ImportClause = 261,
        NamespaceImport = 262,
        NamedImports = 263,
        ImportSpecifier = 264,
        ExportAssignment = 265,
        ExportDeclaration = 266,
        NamedExports = 267,
        NamespaceExport = 268,
        ExportSpecifier = 269,
        MissingDeclaration = 270,
        ExternalModuleReference = 271,
        JsxElement = 272,
        JsxSelfClosingElement = 273,
        JsxOpeningElement = 274,
        JsxClosingElement = 275,
        JsxFragment = 276,
        JsxOpeningFragment = 277,
        JsxClosingFragment = 278,
        JsxAttribute = 279,
        JsxAttributes = 280,
        JsxSpreadAttribute = 281,
        JsxExpression = 282,
        CaseClause = 283,
        DefaultClause = 284,
        HeritageClause = 285,
        CatchClause = 286,
        PropertyAssignment = 287,
        ShorthandPropertyAssignment = 288,
        SpreadAssignment = 289,
        EnumMember = 290,
        UnparsedPrologue = 291,
        UnparsedPrepend = 292,
        UnparsedText = 293,
        UnparsedInternalText = 294,
        UnparsedSyntheticReference = 295,
        SourceFile = 296,
        Bundle = 297,
        UnparsedSource = 298,
        InputFiles = 299,
        JSDocTypeExpression = 300,
        JSDocAllType = 301,
        JSDocUnknownType = 302,
        JSDocNullableType = 303,
        JSDocNonNullableType = 304,
        JSDocOptionalType = 305,
        JSDocFunctionType = 306,
        JSDocVariadicType = 307,
        JSDocNamepathType = 308,
        JSDocComment = 309,
        JSDocTypeLiteral = 310,
        JSDocSignature = 311,
        JSDocTag = 312,
        JSDocAugmentsTag = 313,
        JSDocImplementsTag = 314,
        JSDocAuthorTag = 315,
        JSDocDeprecatedTag = 316,
        JSDocClassTag = 317,
        JSDocPublicTag = 318,
        JSDocPrivateTag = 319,
        JSDocProtectedTag = 320,
        JSDocReadonlyTag = 321,
        JSDocCallbackTag = 322,
        JSDocEnumTag = 323,
        JSDocParameterTag = 324,
        JSDocReturnTag = 325,
        JSDocThisTag = 326,
        JSDocTypeTag = 327,
        JSDocTemplateTag = 328,
        JSDocTypedefTag = 329,
